...
function SIM.setupMap(zip,mapName,tiled)
...
function MENU.init()
  setTitle(" Z E K E   O N   Y O U R   S I X")
  MENU.GUI = {}
  empty()
  emptyOverlay()
  local zip = Zip("ZekeOnYourSix.dat")
